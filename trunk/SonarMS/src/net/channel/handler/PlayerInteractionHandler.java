...
public class PlayerInteractionHandler extends AbstractMaplePacketHandler {
    private enum Action {
        ...
        CHAT(6), EXIT(0xA), OPEN(0xB), SET_ITEMS(0xE),
        SET_MESO(0xF), CONFIRM(0x10), ADD_ITEM(0x14), BUY(0x15), REMOVE_ITEM(0x18),
        ...
        PUT_ITEM(0x1F), MERCHANT_BUY(0x20), TAKE_ITEM_BACK(0x24), MAINTENANCE_OFF(0x25), CLOSE_MERCHANT(0x27);
        final byte code;
    ...
    public void handlePacket(SeekableLittleEndianAccessor slea, MapleClient c) {
        ...
        if (mode == Action.CREATE.getCode()) {
            ...
            if (perBundle > 2000 || perBundle < 0 || bundles > 2000 || bundles < 0 || price > 2147483647 || price < 0)
                return;
