        ...
        if (status == 0) {
            ...
            if (possibleJobs.length == 0) {
                ...
                for (var i = 0; i < possibleJobs.length; i++)
                    text += "\r\n#L"+i+"#"+cm.getJobName(possibleJobs[i])+"#l";
                cm.sendSimple(text);
            }
        } else if (status == 1) {
