//Kippieeej for the base of the script, Tommy of SonarMS for editing.
var status = 0;
...
function action(mode, type, selection) {
    ...
    cm.dispose();
		...
		cm.sendOk("Don't get too carried away. If you trade in your money sack now, you wont get any mesos!");
                cm.dispose();
