...
function start(ms) {
    ...
    if (stage % 6 > 0) {
        ...
        ms.getClient().getSession().write(MaplePacketCreator.environmentChange("Dojang/start", 4));
        ms.getClient().getSession().write(MaplePacketCreator.environmentChange("dojang/start/stage", 3));
        ms.getClient().getSession().write(MaplePacketCreator.environmentChange("dojang/start/number/" + realstage, 3));
