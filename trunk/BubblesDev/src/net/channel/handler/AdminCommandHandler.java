...
public final class AdminCommandHandler extends AbstractMaplePacketHandler implements MaplePacketHandler {
    public final void handlePacket(SeekableLittleEndianAccessor slea, MapleClient c) {
        ...
        switch (mode) {
            case 0x00: // Level1~Level8 & Package1~Package2
                int summonBag = slea.readInt();
                int[][] toSpawn = MapleItemInformationProvider.getInstance().getSummonMobs(summonBag);
