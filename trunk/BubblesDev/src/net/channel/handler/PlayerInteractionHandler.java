...
public final class PlayerInteractionHandler extends AbstractMaplePacketHandler {
    private enum Action {
        CREATE(0), INVITE(2), DECLINE(3), VISIT(4),
        CHAT(6), EXIT(10), OPEN(11), SET_ITEMS(14),
        SET_MESO(15), CONFIRM(16), ADD_ITEM(20), BUY(21), REMOVE_ITEM(24),
        PUT_ITEM(31), MERCHANT_BUY(32), TAKE_ITEM_BACK(36), MAINTENANCE_OFF(37), CLOSE_MERCHANT(39),
        REQUEST_TIE(44), ANSWER_TIE(45), GIVE_UP(46),
        EXIT_AFTER_GAME(50), CANCEL_EXIT(51), READY(52), UN_READY(53), MOVE_OMOK(58), START(55), SKIP(57), SELECT_CARD(62);
        final byte code;
    ...
    public final void handlePacket(SeekableLittleEndianAccessor slea, MapleClient c) {
        ...
        if (mode == Action.CREATE.getCode()) {
            ...
            if (perBundle > 2000 || perBundle < 0 || bundles > 2000 || bundles < 0 || price > 2147483646 || price < 0)
                return;
            IItem ivItem = c.getPlayer().getInventory(type).getItem(slot);
            if (!c.getPlayer().haveItem(c.getPlayer().getInventory(type).getItem(slot).getItemId(), bundles, false, true)) {
                return;
            }
