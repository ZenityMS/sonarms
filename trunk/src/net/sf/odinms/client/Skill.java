...
public class Skill implements ISkill {
	...
	public static Skill loadFromData(int id, MapleData data) {
		...
		if (skillType != -1) {
			...
			switch (id) {  
                ...
                case 8001001: // teleport (new gm job, thinks it's a buff)
				...
				case 10001001:// Recovery (Noblesse)
                case 10001002:// Nimble Feet (Noblesse)
                case 10001004:// Monster Riding (Noblesse)
                case 10001005:// Echo of Hero (Noblesse)
				...
				case 13101006:// Wind Walk (Wind Archer)
				case 13111004:// Puppet (Wind Archer)
				case 13111005:// Eagle Eye (Wind Archer)
				
				case 14001003:// Dark Sight (Night Walker)
				case 14001005:// Darkness (Night Walker)
				case 14101002:// Claw Booster (Night Walker)
				case 14111000:// Shadow Partner (Night Walker)
				...
				case 15111006:// Spark (Thunder Breaker)
					isBuff = true;
					break;
			}
		}
	...
	public boolean canBeLearnedBy(MapleJob job) {
		...
		if (job.isA(MapleJob.NOBLESSE)) {
			...
			if ((skillForJob / 100) % 100 > (jid / 100) % 100) { // wrong 2nd job
				return false;
			}
			if (skillForJob % 100 > jid % 100) { // wrong 3rd/4th job
				return false;
			}
		} else {
