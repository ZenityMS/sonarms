...
public class MonsterDropCreator {
    ...
    public static void main(String args[]) throws FileNotFoundException, IOException, NotBoundException, InstanceAlreadyExistsException, MBeanRegistrationException, NotCompliantMBeanException, MalformedObjectNameException {
		...
		/*System.out.println("I suggest you not to use it if your system RAM is lesser than 30mb.");
		System.out.println("Press any key to continue...");
		System.console().readLine();
		System.out.println("The owner of this programme is not responsible for anything ");
		System.out.println("Press any key to continue...");
		System.console().readLine();
	
		System.out.println("If this program accidentally screws up and destroys data on your PC, electrocutes you,makes your monitor explode in your face, " +
			"set's your house on fire, kills you, changes all the text you say in online games to oink," +
			" causes everyone on the planet(and beyond) to try to kill you, hacks into a nearby nuclear misile and targets your house, " +
			"changes your bank balance to $0, gets you banned from online games, adds your name to a hitman's list, sucks you into the computer and plays pong with you(with you as ball), " +
			"causes secret agencies to come after you, makes you believe you got maggots crawling under your skin, turns your room into a gate to hell, " +
			"becomes sentient and starts killing everyone on this planet, gets you sent to jail with a guy named big bubba or does anything else you don't want it to do, " +
			"don't blame the author of this program!!");
		System.out.println("Now I give you 20 seconds to read this.");
		...
		try {
		    ...
		    System.err.println("Omfg, system failure" + e);
		    return;
		}
    ...
    public static void getAllMobs() {
		...
		for (MapleData itemFolder : mob.getChildren()) { // Get the list of mobs from String.wz
			...
			MobInfo mobInfo = new MobInfo(id == 8810018 ? 1 : MapleDataTool.getIntConvert("boss", monsterData.getChildByPath("info"), 0), // fix for HT
