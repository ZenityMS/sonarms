...
-- By ---------------------------------------------------------------------------------------------
	Minew
-- Description ------------------------------------------------------------------------------------
	Temple of Time portals
-- Version Info -----------------------------------------------------------------------------------
	1.0 - First Version by Minew
-- Additional Comments ----------------------------------------------------------------------------
	Thanks to Vana
---------------------------------------------------------------------------------------------------
**/
...
function enter(pi) {
    ...
    if (pi.getQuestStatus(quest) == org.character.MapleQuestStatus.Status.COMPLETED) {
        ...
        pi.warp(tomap,0);
        pi.getPlayer().dropMessage("Those who have not received permission cannot walk against the flow of the temple and will return to the previous place.");
        return true;
    }
}  