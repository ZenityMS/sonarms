...
function enter(pi) {
	if (pi.getPlayer().getMap().getMonsterById(9300216) != null) {
		...
		pi.getClient().getSession().write(MaplePacketCreator.serverNotice(5, "So Gong: Haha! You're going to run away like a coward? I won't let you get away that easily!"));
	}
	return true;
}